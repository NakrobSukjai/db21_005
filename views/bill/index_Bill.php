...
<?php
    foreach($billList as $bill)
    {
        ...
        <td> <a href=?controller=bill&action=deleteConfirm &Bill_ID=$bill->bill_id &Date=$bill->date &Pay_Name=$bill->P_Name &E_Name=$bill->emp_name &C_Name=$bill->cus_name>delete</td>
        ";
    }
    echo "</table>";
?>
