...
<?php
    foreach($rateList as $rate)
    {
        ...
        <td><a href=?controller=rate&action=updateFormRate&Product_ID=$rate->P_Name&Quantity=$rate->quantity&Price=$rate->price&PriceAddPerColor=$rate->priceaddpercolor>update</td>
        <td>delete</td>
        ";
    }
    echo "</table>";
